...
IPCChainTester_set_native_contract_args::~IPCChainTester_set_native_contract_args() noexcept {
}


uint32_t IPCChainTester_set_native_contract_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t IPCChainTester_set_native_contract_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
IPCChainTester_set_native_contract_pargs::~IPCChainTester_set_native_contract_pargs() noexcept {
}


uint32_t IPCChainTester_set_native_contract_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
IPCChainTester_set_native_contract_result::~IPCChainTester_set_native_contract_result() noexcept {
}


uint32_t IPCChainTester_set_native_contract_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t IPCChainTester_set_native_contract_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("IPCChainTester_set_native_contract_result");
...
IPCChainTester_set_native_contract_presult::~IPCChainTester_set_native_contract_presult() noexcept {
}


uint32_t IPCChainTester_set_native_contract_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
IPCChainTester_enable_debugging_args::~IPCChainTester_enable_debugging_args() noexcept {
}


uint32_t IPCChainTester_enable_debugging_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t IPCChainTester_enable_debugging_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("IPCChainTester_enable_debugging_args");
...
IPCChainTester_enable_debugging_pargs::~IPCChainTester_enable_debugging_pargs() noexcept {
}


uint32_t IPCChainTester_enable_debugging_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("IPCChainTester_enable_debugging_pargs");
...
IPCChainTester_enable_debugging_result::~IPCChainTester_enable_debugging_result() noexcept {
}


uint32_t IPCChainTester_enable_debugging_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t IPCChainTester_enable_debugging_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("IPCChainTester_enable_debugging_result");
...
IPCChainTester_enable_debugging_presult::~IPCChainTester_enable_debugging_presult() noexcept {
}


uint32_t IPCChainTester_enable_debugging_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
bool IPCChainTesterClient::recv_set_native_contract()
{
  ...
  if (fname.compare("set_native_contract") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  bool _return;
  IPCChainTester_set_native_contract_presult result;
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "set_native_contract failed: unknown result");
}

void IPCChainTesterClient::enable_debugging(const bool enable)
{
  send_enable_debugging(enable);
  recv_enable_debugging();
}

void IPCChainTesterClient::send_enable_debugging(const bool enable)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("enable_debugging", ::apache::thrift::protocol::T_CALL, cseqid);

  IPCChainTester_enable_debugging_pargs args;
  args.enable = &enable;
  args.write(oprot_);
...
void IPCChainTesterClient::recv_enable_debugging()
{
  ...
  if (fname.compare("enable_debugging") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  IPCChainTester_enable_debugging_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void IPCChainTesterProcessor::process_set_native_contract(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("IPCChainTester.set_native_contract", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "IPCChainTester.set_native_contract");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "IPCChainTester.set_native_contract");
  }

  IPCChainTester_set_native_contract_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "IPCChainTester.set_native_contract", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "IPCChainTester.set_native_contract");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("set_native_contract", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "IPCChainTester.set_native_contract");
  }

  oprot->writeMessageBegin("set_native_contract", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "IPCChainTester.set_native_contract", bytes);
  }
}

void IPCChainTesterProcessor::process_enable_debugging(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("IPCChainTester.enable_debugging", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "IPCChainTester.enable_debugging");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "IPCChainTester.enable_debugging");
  }

  IPCChainTester_enable_debugging_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "IPCChainTester.enable_debugging", bytes);
  }

  IPCChainTester_enable_debugging_result result;
  try {
    iface_->enable_debugging(args.enable);
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "IPCChainTester.enable_debugging");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("enable_debugging", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "IPCChainTester.enable_debugging");
  }

  oprot->writeMessageBegin("enable_debugging", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "IPCChainTester.enable_debugging", bytes);
  }
}
...
bool IPCChainTesterConcurrentClient::recv_set_native_contract(const int32_t seqid)
{
...
void IPCChainTesterConcurrentClient::enable_debugging(const bool enable)
{
  int32_t seqid = send_enable_debugging(enable);
  recv_enable_debugging(seqid);
}

int32_t IPCChainTesterConcurrentClient::send_enable_debugging(const bool enable)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("enable_debugging", ::apache::thrift::protocol::T_CALL, cseqid);
...
void IPCChainTesterConcurrentClient::recv_enable_debugging(const int32_t seqid)
{
